        ...
        services?.forEach((service) {
          for (BluetoothCharacteristic characteristic
            ...
            if (characteristic.uuid ==
              ...
              characteristic.read().then((values) {
            ...
            if (characteristic.uuid ==
                Guid("f78ebbff-c8b7-4107-93de-889a6a06d408")) {
      ...
      body: Column(
        children: [
          ...
          if (utilsCharacteristic != null) ...[
            BuzzCharacteristicContainer(
              buzzCharacteristic: utilsCharacteristic,
              isBuzzActive: isBuzzActive,
            ),
            FileSystemCharacteristicContainer(
              filesystemCharacteristic: utilsCharacteristic,
              isWriting: isWriting,
            ),
            ServoCharacteristicContainer(
                servoCharacteristic: utilsCharacteristic),
          ],
        ],
      ),
      floatingActionButton: utilsCharacteristic != null
          ? PropulsionCharacteristicContainer(
              propulsionCharacteristic: utilsCharacteristic)
          : null,
